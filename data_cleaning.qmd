...
team_streaks <- streak_data |>
  ...
  summarize(stats = list(streak_stats(is_make, streak_length)), .groups = "drop") |>
  unnest(stats)
...
Investigate individual players when team looks hot? Napheesa Collier had streak of length 7!!
