...
# RESULTS:
# AIC = 4656.359
# 460 instances of state 1, 2 instances of state 2
fits <- depmix(event ~ shot_dist, nstates = 2, family=multinomial(), ntimes = game_obslength_vec[[1]], data = df_discrete_lv2022)
...
# RESULTS:
# AIC = 4672.647
# 2 instances of state 1, 2 instances of state 2, 331 instances of state 3
fits2 <- depmix(event ~ shot_dist, nstates = 3, family=multinomial(), ntimes = game_obslength_vec[[1]], data = df_discrete_lv2022)
