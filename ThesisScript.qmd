...
```{r}
build_data <- function(df, team, season){
  shot_data |>
    filter(team_id == team,
           season == season) |>
...
champs_2022 <- build_data(shot_data, 17, 2022)
champs_2023 <- build_data(shot_data, 17, 2023)
champs_2024 <- build_data(shot_data, 9, 2024)
```
