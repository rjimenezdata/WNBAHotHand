...
shot_data |>
  ggplot(aes(x = shot_dist, y = as.integer(scoring_play))) + geom_smooth() + scale_y_continuous(labels = scales::percent_format(),
                                                                                                limits = c(0, 1)) + theme_minimal() + theme(panel.grid.minor = element_blank()) + labs(x = "Shot Distance (ft)",
                                                                                                                                                                                                        y = "",
                                                                                                                                                                                       title = "Shooting Percentage from Distance")
